...
class IRC:
    ...
    def __init__(self, fn_to_add_socket=None,
        ...
        self.connections = []
        self.handlers = {}
        self.delayed_commands = [] # list of tuples in the format
    ...
    def process_timeout(self):
        ...
        while self.delayed_commands:
            if t >= self.delayed_commands[0][0]:
                self.delayed_commands[0][3](*self.delayed_commands[0][2])
    ...
    def process_once(self, timeout=0):
        ...
        sockets = [x for x in sockets if x != None and x.fileno() > 0] # XXX
        if sockets:
    ...
    def execute_delayed(self, delay, function, arguments=()):
        ...
        bisect.insort(self.delayed_commands,
            (delay+time.time(), function.__name__, arguments, function))
...
class ServerConnection(Connection):
    ...
    def connect(self, server, port, nickname, password=None, username=None,
                ircname=None, localaddress="", localport=0, use_ssl=False,
                ipv6=False):
        ...
        Arguments:
            ...
            use_ssl -- Enable support for ssl.
    ...
    def close(self):
        ...
        self.disconnect(b"Closing object")
...
class SimpleIRCClient(object):
    ...
    def __init__(self):
        ...
        self.ircobj.add_global_handler("dcc_disconnect", self._dcc_disconnect,
            -10)
...
lowercase_letters = b"abcdefghijklmnopqrstuvwxyz{}|~"
uppercase_letters = b"ABCDEFGHIJKLMNOPQRSTUVWXYZ[]\\^"
nick_characters = lowercase_letters + uppercase_letters + b"0123456789-'"
_ircstring_translation = bytes.maketrans(uppercase_letters, lowercase_letters)
...
def parse_channel_modes(mode_string):
    ...
    >>> irclib.parse_channel_modes(b"+ab-c foo")
    [(b'+', b'a', None), (b'+', b'b', b'foo'), (b'-', b'c', None)]
    """
...
def _parse_modes(mode_string, unary_modes=""):
    ...
    if mode_part[0] not in [43, 45]: # b"+-"
        return []
    for i in range(len(mode_part)):
        ch = mode_part[i:i+1]
        if ch in b"+-":
            sign = ch
        elif ch == b" ":
